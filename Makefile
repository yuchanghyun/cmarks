...
.PHONY: gen build build-appstore archive-appstore run test test-packages test-web test-app assets icon install release logs clean
...
clean:
	rm -rf $(DERIVED) build-appstore $(PROJECT)
