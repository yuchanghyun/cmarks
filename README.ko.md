...
cmarks는 편집기가 아니라 뷰어입니다. Quick Look과 본격 편집기 사이에 있습니다.

| | cmarks | QLMarkdown | Marked 2 | Typora | Obsidian |
|---|---|---|---|---|---|
| 무엇인가 | 워크스페이스가 있는 뷰어 | Quick Look 확장 | 미리보기 앱 | 편집기 | 노트 앱 |
| 문서를 탭·분할로 붙잡아 둠 | ✓ | — | 창 단위만 | 탭 | 탭·패인 |
| GitHub의 렌더러(cmark-gfm)와 스타일시트 | ✓ | ✓ | GitHub 스타일 선택 가능 | 자체 렌더러 | 자체 렌더러 |
| 다른 앱이 고치는 동안 라이브 리로드 | ✓ | — | ✓ | 편집기 자체 | 편집기 자체 |
| Quick Look 확장 포함 | ✓ | ✓ | — | — | — |
| 파일을 절대 수정하지 않음 | ✓ | ✓ | ✓ | 편집 | 편집 |
| 가격 | 무료 | 무료 | 유료 | 유료 | 개인 사용 무료 |
| 오픈소스 | MIT | GPL | — | — | — |

2026년 9월 기준 각 제품 공개 페이지를 참고했습니다. 틀린 부분은 이슈로 알려 주세요.
